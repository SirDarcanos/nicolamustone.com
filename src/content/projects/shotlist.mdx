...
seoDescription: shotlist helps documentation teams create repeatable, annotated UI screenshots from reviewable YAML recipes and catch visual drift in CI.
relatedProjects:
  - project: agent-skills
    description: Reusable agent workflows, including tools for building and reviewing software.
